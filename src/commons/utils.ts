...
Return the above as a JSON object with keys 'step1', 'step2', 'step3', 'location', 'summary'. For this location:  ${latitude}, ${longitude}. Past locations: ${locationsToAvoid}`;
